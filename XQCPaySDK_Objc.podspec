...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.resource = 'XQCPaySDK_Objc/Classes/UMSPosPayOnly/*.bundle','XQCPaySDK_Objc/Frameworks/AlipaySDK.bundle'
  s.resource_bundles = {
  ...
  s.vendored_frameworks = 'XQCPaySDK_Objc/Frameworks/YSEPaySDK.framework','XQCPaySDK_Objc/Frameworks/AlipaySDK.framework'
